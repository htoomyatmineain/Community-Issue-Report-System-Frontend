...
export default function FeedbackForm({ feedback, onSubmit, isSubmitting, error }) {
  ...
  if (feedback) {
    return (
      <section className="flex flex-col gap-3 rounded-lg bg-muted p-6">
        <h2 className="font-display text-sm font-bold text-foreground">Your feedback</h2>
  ...
  return (
    <section className="flex flex-col gap-3 rounded-lg bg-muted p-6">
      <h2 className="font-display text-sm font-bold text-foreground">How did we do?</h2>
