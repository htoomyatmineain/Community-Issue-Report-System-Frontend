  ...
  return (
    <div className="flex w-full max-w-md flex-col">
      <header className="flex items-center gap-3 px-5 pb-2 pt-4">
        ...
        <h1 className="font-display text-base font-bold text-foreground">{t("My score")}</h1>
      </header>
          ...
          <>
            <section className="flex items-center justify-between rounded-lg bg-primary p-6 text-primary-foreground">
              <div className="flex flex-col gap-1">
                <span className="text-xs text-blue-100">{t("Total points")}</span>
                <span className="font-display text-[26px] font-bold leading-none">
                  {(data?.totalPoints ?? 0).toLocaleString()} {t("pts")}
                </span>
              </div>
            ...
            <section className="flex flex-col gap-2.5">
              <h2 className="text-sm font-semibold text-foreground">{t("Point history")}</h2>
