...
export default function AuthLayout({ eyebrow, headline, children, className }) {
  return (
    <div className={cn("grid min-h-screen w-full grid-cols-1 bg-card md:grid-cols-2", className)}>
      <div className="relative hidden flex-col justify-between overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-700 p-10 md:flex lg:p-16">
        ...
        <div className="relative z-10 flex flex-col gap-2">
          <span className="text-[13px] font-medium text-white/70">{eyebrow}</span>
          <h2 className="font-display text-[28px] font-bold leading-snug text-white">{headline}</h2>
        </div>
      </div>
