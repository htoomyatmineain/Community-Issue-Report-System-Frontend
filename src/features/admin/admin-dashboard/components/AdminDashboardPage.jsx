...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="font-display text-2xl font-bold text-ink">{t("Admin Dashboard")}</h1>
        <p className="text-sm text-ink-muted">{t("City-wide account and report activity at a glance.")}</p>
      </div>
      ...
      {error ? (
        ...
        <>
          ...
          <div className="rounded-console border border-console-border bg-surface p-6">
            <h2 className="font-display text-base font-bold text-ink">{t("Issue volume by category")}</h2>
            <div className="mt-4">
